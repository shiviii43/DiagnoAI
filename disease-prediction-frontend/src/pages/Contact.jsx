...
function Contact() {
  ...
  return (
    <div className=" max-w-2xl bg-white/60 backdrop-blur-lg border border-white/20 shadow-xl mx-auto my-10 rounded-3xl p-7">
      ...
      <form className="bg-blue-50 flex flex-col m-5 p-4 rounded-3xl">
        ...
        <button className="mt-3 bg-blue-500 w-30 mx-auto rounded-3xl text-white hover:scale-102 hover:bg-blue-800 ">Send Message</button>
      </form>
      <h1>Contact Info</h1>
